...
class Job(proto.Message):
    ...
    pubsub_target = proto.Field(proto.MESSAGE, number=4, oneof='target',
        message=target.PubsubTarget,
    )

    app_engine_http_target = proto.Field(proto.MESSAGE, number=5, oneof='target',
        message=target.AppEngineHttpTarget,
    )

    http_target = proto.Field(proto.MESSAGE, number=6, oneof='target',
    ...
    user_update_time = proto.Field(proto.MESSAGE, number=9,
    ...
    schedule_time = proto.Field(proto.MESSAGE, number=17,
        message=timestamp.Timestamp,
    )

    last_attempt_time = proto.Field(proto.MESSAGE, number=18,
        message=timestamp.Timestamp,
    )

    retry_config = proto.Field(proto.MESSAGE, number=19,
        message='RetryConfig',
    )

    attempt_deadline = proto.Field(proto.MESSAGE, number=22,
...
class RetryConfig(proto.Message):
    ...
    min_backoff_duration = proto.Field(proto.MESSAGE, number=3,
        message=duration.Duration,
    )

    max_backoff_duration = proto.Field(proto.MESSAGE, number=4,
        message=duration.Duration,
    )
