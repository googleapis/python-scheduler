...
AppEngineRouting = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      ...
      host:
          ...
          `here <https://cloud.google.com/appengine/docs/standard/python
          /how-requests-are-routed>`__.  The host is constructed as:  -
...
OAuthToken = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      service_account_email:
          ...
          /service-accounts>`__ to be used for generating OAuth token.
          The service account must be within the same project as the
          job. The caller must have iam.serviceAccounts.actAs permission
...
OidcToken = _reflection.GeneratedProtocolMessageType(
  ...
  Attributes:
      service_account_email:
          \ `Service account email <https://cloud.google.com/iam/docs
          /service-accounts>`__ to be used for generating OIDC token.
          The service account must be within the same project as the
          job. The caller must have iam.serviceAccounts.actAs permission
          for the service account.
      audience:
